...
#for(s in 1:length(sites)){
  ...
  if(ncol(dataFinal$TairMu)>1 & file.exists(paste0(sites[s],'_meanTemp_fall_expBreak_slope_b3_calibration_varBurn.RData'))){
    
    NT <- length(dataFinal$TairMu[,1])
    load(paste0(sites[s],'_meanTemp_fall_expBreak_slope_b3_calibration_varBurn.RData'))
