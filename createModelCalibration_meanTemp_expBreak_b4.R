...
foreach(s =1:length(sites)) %dopar% {
  ...
  #outputFileName <- paste0(siteName,"_summerIncludeJuly_meanTemp_expBreak_b4_calibration_varBurn.RData")
  outputFileName <- paste0(siteName,"_meanTempIncludeJuly_expBreak_b4_calibration_varBurn.RData")
